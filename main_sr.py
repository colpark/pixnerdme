"""
Super-Resolution Training Entry Point
Uses SuperResolutionLightningModel for image-conditioned SR
"""
import os
import torch
import time
...
if __name__ == "__main__":
    # Use SuperResolutionLightningModel instead of LightningModel
    cli = ReWriteRootDirCli(SuperResolutionLightningModel, DataModule,
